...
collections:
  - '9'
date: '2014-01-07 16:49:52'
draft: false
dublin_core:
  Title:
    - html: false
      text: 'Re: [MAPC-coord] cc mission for approval, gm agenda'
featured: false
files: []
geo:
id: 1056
...
item_type_metadata:
  'September 11 Email: Body':
    - html: false
      text: |-
        I think your suggestion has a lot of promise, X; however, I am concerned about coordinating it for this week's meeting.  I think if we do it, it might make more sense for this particular meeting to focus on the events coming up, rather than the general, sweeping tasks, like poster distribution or creation.  I think the events are more "gelling" as forces and focii to catch people's interest ("hey, I could work on that...") and to allow for communication, teamwork, etc.  It would be overwhelming for a group to discuss creating or distributing flyers for three events, while looking at the holistic effort for one event has a managability.

        If anyone likes this suggestion, that we (at least for this week) break into working groups based on event

        Nov 17, art auction, Nov 30, etc, etc,

        with perhaps the addition of the brochure or website improvement,

        I would be more than happy to facilitate the Nov 30 event group.  To tell you the truth, I'd feel pretty overhwhelmed myself to work on any of the other thematic groups you suggested --I'm game, but I wouldn't feel nearly as comfortable.

        Feedback?

        X

        P.S. thanks for the thoughtful suggestion --good call on getting non-committee people working on something... I really like it....let's keep going with this???
        ...
        >Date: Mon, 12 Nov 2001 03:55:53 -0600
        ...
        _______________________________________________ coordination@madpeace.org http://lists.OpenSoftwareServices.com/mailman/listinfo/madpeace-cc
  'September 11 Email: CC':
    - html: false
      text: 'NULL'
  'September 11 Email: Date':
    - html: false
      text: Monday, November 12, 2001 5:00 PM
...
sortdate: '9999-99-99'
tags: []
title: 'Re: [MAPC-coord] cc mission for approval, gm agenda'
type: items
---
