  ...
  'September 11 Email: Body':
    - html: false
      text: |-
        ...
        survivors of a dishwasher in one of the restaurants destroyed. Justice requires looking far beyond
        the last paycheck to the inherent worth of all those killed, so that a high minimum compensation
        level is set to lessen the disparities. It would be a double blow to the survivors to first lose their
        loved one and then watch as most of the taxpayer money went to those who were already well off
        in the first place.
