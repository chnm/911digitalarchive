  ...
  'September 11 Email: Body':
    - html: false
      text: |-
        ...
        year might receive thousands of times as much compensation as the survivors of a diswasher in one of the
        restaraunts destroyed. Justice requires looking far beyond the last paycheck to the inherent worth of all
        those killed, so that a high minimum compensation level is set to lessen the disparities. It would be a double
        blow to the survivors to first lose their loved one and then watch as most of the taxpayers money went to those
        ...
        families. Gay and lesbian famillies are especially vulerable when one partner is killed. Because the option of
        marriage is unavailable, these families may find themselves in a traumatic predicament of having to prove
        that their union is legitimate. Fortunaely, both the Red Cross and the State of New York have already
