...
item_type_metadata:
  'September 11 Email: Body':
    - html: false
      text: |-
        ...
        If we  (simply and no more) follow the second Bush crusade into the desert to ferret out and destroy the enemy, and call the job done when we get Afghanistan to spit up Bin Laden, then well learn the French history lesson - Plus ca change, plus la meme chose
  ...
  'September 11 Email: CC':
    - html: false
      text: oakenhamplantation@usa.net
  'September 11 Email: Date':
    - html: false
      text: About a week after 9/11.
  'September 11 Email: From':
    - html: false
      text: rschoch@triad.rr.com
  'September 11 Email: Subject':
    - html: false
      text: Stand Behind Me, America, and Take Responsibility
  'September 11 Email: To':
    - html: false
      text: rschoch@triad.rr.com
lastmod: '2014-09-11 02:02:49'
layout: single
outputs:
  - html
  - dcmesxml
